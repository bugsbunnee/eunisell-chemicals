      ...
      <div className="w-full text-center z-40">
        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-center mt-6 md:mt-14 gap-4 md:gap-x-4">
          <Button
            ...
            className="w-full md:w-auto rounded-xs bg-secondary font-bold md:font-semibold text-[16px] md:text-base h-13.5 md:h-13 md:px-7"
          >
          ...
          <Button
            onClick={() => navigate(paths.contact)}
            className="w-full md:w-auto rounded-xs bg-transparent border border-primary-foreground/30 md:border-primary-foreground/40 font-normal md:font-semibold text-[16px] md:text-base h-13.5 md:h-13 md:px-7"
          >
        ...
        <div className="mt-8 md:mt-11 flex flex-col md:flex-row items-center justify-center gap-2 md:gap-x-5.5">
          <Link className="text-[12px] md:text-[13px] text-primary-foreground/40" to={paths.contact}>
            · Product Enquiries
          </Link>
