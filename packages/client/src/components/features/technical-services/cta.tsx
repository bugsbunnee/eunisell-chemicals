  ...
  return (
    <section className="py-16 px-6 md:py-24 md:px-30 text-center bg-accent relative">
      ...
      <div className="relative z-10">
        <div className="text-[30px] md:text-5xl leading-[38px] md:leading-12 font-bold text-white max-w-4xl mx-auto">
          Need Technical Support for Your Operation?
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-6 mt-8 md:mt-12 items-center justify-center">
          <Link
            to={paths.contact}
            className="w-full md:w-auto h-[56px] md:h-auto flex items-center justify-center bg-secondary text-white font-bold text-sm md:text-lg leading-7 md:px-10 md:py-5 rounded-[4px]"
          >
            Get Started Today
          </Link>
          <Link
            to={paths.contact}
            className="w-full md:w-auto h-[56px] md:h-auto flex items-center justify-center border border-white/30 text-white font-bold text-sm md:text-lg leading-7 md:px-10 md:py-5 rounded-[4px]"
          >
            View Technical Blog
          </Link>
        </div>
