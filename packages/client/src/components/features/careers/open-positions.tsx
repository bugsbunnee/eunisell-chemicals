        ...
        <div className="flex flex-col gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-12 bg-white border border-[#e8e8e8] rounded-[4px] pl-10 pr-4 text-[14px] text-foreground placeholder:text-sidebar-foreground outline-none"
            />
          </div>
          <select
            value={department}
            ...
            <div className="flex gap-4 items-center">
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => setSearch(e.target.value)}
                  placeholder="Search roles..."
                  className="w-[300px] h-12 bg-white border border-[#e8e8e8] rounded-[4px] pl-10 pr-4 text-[16px] text-foreground placeholder:text-sidebar-foreground outline-none focus:border-secondary/50 transition-colors"
                />
              </div>
              <select
                value={department}
