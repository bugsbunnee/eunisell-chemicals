...
const BlogAdminFilters: React.FC = () => {
        ...
        <div className="flex items-center gap-2 shrink-0">
          <div className="relative">
            <select
              ...
              onChange={(e) => store.onChangeQuery({ category: e.currentTarget.value, page: 1 })}
            ...
            >
              ...
              {['Technical Article', 'Industry Insights', 'Company Updates'].map((c) => (
          ...
          <div className="relative">
            <select
              ...
              onChange={(e) => store.onChangeQuery({ status: e.currentTarget.value, page: 1 })}
              className="appearance-none pl-5 pr-8 py-[10.5px] text-[14px] border border-border rounded-[6px] text-[#777] bg-[#f9fafb] outline-none focus:border-secondary/60 transition-colors cursor-pointer"
            >
...
export default BlogAdminFilters;
