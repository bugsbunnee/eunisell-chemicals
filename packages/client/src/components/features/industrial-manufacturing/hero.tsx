...
const Hero: React.FC = () => {
  return (
    <section className="bg-accent relative text-left">
      ...
      {/* Content */}
      <div className="z-50 relative px-6 pt-12 pb-0 md:py-44.25 md:px-30">
        ...
        <p className="font-normal text-[16px] md:text-xl leading-[26px] md:leading-[32.5px] text-primary-foreground/80 mt-6 max-w-full md:max-w-146.25">
          Advanced chemical solutions engineered to optimize performance, protect critical assets, and ensure the highest standards of product quality
          across the manufacturing value chain.
        </p>

        <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4 md:gap-x-4 mt-8 md:mt-12">
          <Button className="h-[52px] md:h-14 md:px-8 md:py-4 flex items-center justify-center bg-secondary text-sm md:text-base leading-5 md:leading-6 text-white font-bold rounded-[2px] capitalize">
            Explore Products
          </Button>
          <Button className="h-[52px] md:h-14 md:px-8 flex items-center justify-center bg-transparent border border-white/30 text-sm md:text-base leading-5 md:leading-6 text-white font-bold rounded-[2px] capitalize">
