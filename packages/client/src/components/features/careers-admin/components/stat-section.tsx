...
import type { CareerStats } from '../../../../hooks/use-career-openings';
...
const CareerStatSection: React.FC<Props> = ({ stats }) => {
  const cards = [
    {
      icon: BriefcaseIcon,
      iconBg: 'rgba(31,193,107,0.1)',
      iconColor: '#1fc16b',
      tagBg: 'rgba(31,193,107,0.1)',
      tagText: '#1fc16b',
      tag: 'Active',
      value: stats?.open ?? 0,
      label: 'Open Roles',
    ...
    {
      icon: FileTextIcon,
      iconBg: 'rgba(164,164,164,0.1)',
      iconColor: '#a4a4a4',
      tagBg: 'rgba(164,164,164,0.1)',
      tagText: '#a4a4a4',
      tag: 'Pending',
      value: stats?.draft ?? 0,
      label: 'Draft Roles',
    ...
    {
      icon: StarIcon,
      iconBg: 'rgba(0,131,206,0.1)',
      iconColor: '#0083ce',
      tagBg: 'rgba(0,131,206,0.1)',
      tagText: '#0083ce',
      tag: 'Highlighted',
    ...
    {
      icon: XCircleIcon,
      iconBg: 'rgba(208,4,22,0.1)',
      iconColor: '#d00416',
      tagBg: 'rgba(208,4,22,0.1)',
      tagText: '#d00416',
      tag: 'Ended',
...
export default CareerStatSection;
