...
const links = [
  ...
  { url: paths.technical, label: 'Technical Centers' },
  { url: paths.aboutUs, label: 'Investor Relations' },
  { url: paths.careers, label: 'Careers' },
];
  ...
  return (
    <section className="relative bg-accent overflow-hidden px-6 py-16 md:p-30 flex items-center justify-center text-center">
      ...
      <div className="relative z-10 text-center w-full">
        <h2 className="font-bold text-[32px] md:text-[56px] text-white leading-[40px] md:leading-17.5 max-w-full md:max-w-216 mx-auto">Partner with Industry Leaders</h2>
