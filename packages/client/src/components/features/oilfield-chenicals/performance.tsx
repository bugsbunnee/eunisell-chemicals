...
const Performance: React.FC = () => {
  return (
    <section className="bg-accent text-left py-16 px-45">
      <div className="text-4xl leading-13.75 font-bold text-primary-foreground max-w-163.25">
        Built for Production Performance and Mission-Critical Reliability
      </div>
