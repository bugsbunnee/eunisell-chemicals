...
const knowledgeArticle: ArticleDetail = {
  breadcrumb: { label: 'Knowledge Centre', href: '/knowledge' },
      ...
      <ul className="flex flex-col gap-4">
        {blocks.map(({ label, text }) => (
          <li key={label} className="flex items-start gap-3">
            <CheckIcon size={14} className="text-secondary mt-1.25 shrink-0" />
...
const KnowledgeDetailPage: React.FC = () => {
  return <ArticleDetailPage article={knowledgeArticle} />;
};
